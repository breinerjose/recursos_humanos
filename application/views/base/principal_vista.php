...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="../res/bootstrap-datepicker/bootstrap-datepicker.min.css" />   
...
<div class="col-md-12 col-sm-12 col-xs-12">
			  ...
			  <?php 
				$con = mysqli_connect('192.168.150.90','myserver_asapase','AsecoAsap301084+','myserver_asapaseco');
  ...
  <tr>
    <td><table width="700">
      <tr>
        ...
        <td>LIQUIDACION!!! POR CAUSA DEL CORONAVIRUS PARA EL PAGO DE SU LIQUIDACION ENVIE UN CORREO A heidy.castro@asapaseco.com CONTRATO CUYO OFICIO ERA <?php echo $oficio;?> QUE INICIO EL <?php echo $fecini; ?> Y FINALIZO EL <?php echo $fecfin; ?> PARA PROCEDER AL PAGO. </td>
      </tr>
    </table></td>
  </tr>
</table>
...
$this->db->select('*');
$this->db->from('cesantias');
$this->db->where('trim(identificacion)',$this->session->userdata('user'));
$res = $this->db->get();
if($res->num_rows()>0){$r = $res->row_array();
extract($r); ?>
<table width="100%" border="1" align="center" cellpadding="1" cellspacing="0" bordercolor="#0099FF">
<tr><td><H3><?php echo "Hemos Consignado sus Cesantias el dia ".$fecha." por Valor de $".number_format($valor)." En El Fondo "; ?> <img src="../res/images/<?php echo $fondo;?>.jpg" > </H3></td></tr>
</table>
<?php } ?>
			 </div>
...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js" integrity="sha384-Tc5IQib027qvyjSMfHjOMaLkfuWVxZxUPnCJA7l2mCWNIpG9mGCD8wGNIcPD7Txa" crossorigin="anonymous"></script>
    ...
    <script type="text/javascript" src="../res/bootstrap-datepicker/bootstrap-datepicker.min.js"></script>
	<script type="text/javascript" src="../res/bootstrap-datepicker/bootstrap-datepicker.es.min.js"></script>
