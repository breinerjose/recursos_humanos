...
<script type="text/javascript">
	...
	$('#clonar_empresa').click(function(){
			var subgru=($('#subgru').val()!=''||$.type($('#subgru').val()) === "undefined")?$('#subgru').val():0;		
			var codcarb=($('#codcarb').val()!='')?$('#codcarb').val():0;
			var codcar=($('#codcar').val()!='')?$('#codcar').val():0;	
			var id_empresa=($('#id_empresa').val()!='')?$('#id_empresa').val():0;	
			var codpro=($('#codpro').val()!=''||$.type($('#codpro').val()) === "undefined")?$('#codpro').val():0;	
			clonar_empresa(codcarb,codcar,id_empresa,codpro,subgru);
	});
	...
	function clonar_empresa(codcarb,codcar,id_empresa,codpro,subgru){
				var oTable = $('#listado').dataTable({
				"order": [[ 4, "asc" ]],
							  "bPaginate": false,
							  "ordering": true,
...
<div class="row">	
    ...
    <div class="col-md-3">
	  ...
	  <div class="col-md-4">
       <div class="item form-group">
       <label>Empresa</label>
	   <select name="codpro" id="codpro" class="required" data-placeholder="Seleccione Empresa Aseco/Asap">
	   <option></option> 
	 ...
	 <div class="col-md-2">
      ...
      <div class="col-md-3">
       <div class="item form-group">
       <center>
       <button type="button" class="btn btn-info" id="consultar"><i class="fa fa-plus-circle"></i> Consultar</button>
       <button type="button" class="btn btn-primary" id="agregar"><i class="fa fa-plus-circle"></i> Agregar</button>
       </center>
       </div>
       </div>
	<div class="clearfix"></div>
       ...
       <div class="item form-group">
       <center>
	   <button type="button" class="btn btn-success" id="confirmar"><i class="fa fa-plus-circle"></i>Confirmar</button>
	    <button type="button" class="btn btn-success" id="clonar"><i class="fa fa-plus-circle"></i>Ingreso -> Periodico</button>
		<button type="button" class="btn btn-success" id="clonar_cargo"><i class="fa fa-plus-circle"></i>Cargo A -> Cargo B</button>
	   <button type="button" class="btn btn-success" id="clonar_empresa"><i class="fa fa-plus-circle"></i> Clonar Asap->Aseco o Aseco->Asap</button>
       </center>
       </div>
       </div>
	</form>
