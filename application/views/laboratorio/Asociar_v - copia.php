...
<div class="row">	
	...
	<div class="clearfix"></div>
	   ...
	   <button type="button" class="btn btn-success" id="confirmar"><i class="fa fa-plus-circle"></i>Confirmar</button>
	    <button type="button" class="btn btn-success" id="clonar"><i class="fa fa-plus-circle"></i>Clonar Periodico</button>
	   <button type="button" class="btn btn-success" id="confirmar"><i class="fa fa-plus-circle"></i> Clonar Asap-Aseco</button>
       </center>
       </div>
       </div>
	</form>
