...
//////
		 ...
		 $result_e3 = $con->query($sql_e3) or die ("error eliminando tercero");
}
}
///////////
///////////////
...
<tr>
    ...
    <td width="93%" valign="middle">&nbsp; <strong><font color="#000033" size="3" face="Verdana, Arial, Helvetica, sans-serif">GESTIONAR TERCEROS </font></strong></td>
 </tr>
</table>
 ...
 Identificacion 
                  ...
                  <td width="33%">
                    <table width="107" border="0" cellspacing="0" cellpadding="0" align="right">
                      <form name="numRegistrosVer" method="post" action="">
                        <tr>
			...
			aform.elements[r].checked = whatAction;
                    ...
                    <table width="100%" border="0" align="center" bordercolor="black">
                      <tr bgcolor="#0099CC" valign="middle">
                        ...
                        Nombre </font></th>
                        <form name="orderByCol_4" action="" method="post"> <th width="11%">
                           <div align="left">
                             <input type="hidden" name="h_largo_pagina" value="<?php echo $h_largo_pagina; ?>">
                             <input type="hidden" name="orden" value="fecha">
                           <font face="Arial" size="2" color="#FFFFFF">Telefono</font>                           </div></th>
                          <th width="26%"><font face="Arial" size="2" color="#FFFFFF">Direccion</font></th>
                          <th width="5%"><font color="#FFFFFF" size="2" face="Arial">Ver</font></th>
                        </form>
                      </tr>
                      <form action="" method="post" name="resultado_consulta">
                        <?php
//////
$limit=" LIMIT ".$inicial.",".$h_largo_pagina;
if(!isset($_REQUEST['datobusq'])){
$consulta="SELECT * FROM terceros";
...
//echo $consulta;
$resultado2=$con->query($consulta) or die ("error buscando categoria");  
...
?>
                        <tr valign=top <?php if ($sw==0){echo "bgColor=#FFFFFF"; $sw=1;} else{echo "bgColor=#eeeee0"; $sw=0;} ?>>
                          <td width="13%" align="center"><div align="left"><font color="#003366" size="1" face="Verdana, Arial, Helvetica, sans-serif"><?php echo $id_tercero; ?></font></div></td>
                          <td width="31%" align="center"><div align="left"><font color="#003366" size="1" face="Verdana, Arial, Helvetica, sans-serif"><?php echo $NOMBRE; ?></font></div></td>
                          <td align="center"><div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">&nbsp;<?php echo $TELEFONO; ?></font></div></td>
                          <td align="center"><div align="left"><font color="#003366" size="1" face="Verdana, Arial, Helvetica, sans-serif"><?php echo $DIRECCION; ?></font></div></td>
                          <td align="center">
...
<tr valign=top bgcolor="#EFEFEF">
                        <td colspan="8" align="left" valign="middle">
                          ...
                          <table width="10%" border="0" align="right">
                            <tr>
                              <form name="btn1stBlock" method="post" action="">
						...
						<input type="hidden" name="op" value="2"><input type="hidden" name="h_largo_pagina" value="<?php echo $h_largo_pagina; ?>">
                              ...
                              <form name="btnPrevBlock" method="post" action="">
						...
						<input type="hidden" name="op" value="2"><input type="hidden" name="h_largo_pagina" value="<?php echo $h_largo_pagina; ?>">
                              ...
                              <form name="combo_paginador" method="post" action="">
						...
						<input type="hidden" name="op" value="2"><input type="hidden" name="h_largo_pagina" value="<?php echo $h_largo_pagina; ?>">
                              ...
                              <form name="btnNextBlock" method="post" action="">
						...
						<input type="hidden" name="op" value="2"><input type="hidden" name="h_largo_pagina" value="<?php echo $h_largo_pagina; ?>">
                              ...
                              <form name="btnLastBlock" method="post" action="">
