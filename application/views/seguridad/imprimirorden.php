          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td class="Estilo1"><?php echo utf8_decode($ocunom); ?>&nbsp;<?php echo utf8_decode($ocuape); ?></td>
              </tr>
                <tr>
            ...
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td width="21%" class="Estilo1">Empresa:</td>
                <td width="79%" class="Estilo1"><?php echo utf8_decode($oculab); ?></td>
              </tr>
              <tr>
