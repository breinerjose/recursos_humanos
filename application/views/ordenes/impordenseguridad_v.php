      ...
      <tr>
        <td><table width="100%" border="1" cellspacing="0" cellpadding="0">
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="19%" rowspan="2"><img src="/recursos/images/<?php echo $ocupor; ?>.jpg" alt="ocupor" height="60" /></td>
        ...
        <td><table width="100%" border="1" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <tr>
              ...
              <tr>
                <td>&nbsp;&nbsp;&nbsp;
			 <a href="/ordenes/aprobar_orden_seguridad.php?ocunum=<?php echo $ocunum; ?>"></a></td>
              </tr>
            </table></td>
          </tr>
        </table></td>
...
<table width="950" border="1" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td><table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#000000">
      ...
      <tr>
        <td><?php if($addord != ''){?><img src="/recursos/firmas/<?php echo $addord.".jpg";?>"/><?php } ?></td>
        <td><?php if($usuapr != ''){?><img src="/recursos/firmas/<?php echo $usuapr.".jpg";?>"/><?php } ?></td>
