...
function dtl(){
		oTable = $('#usuarios').dataTable( {
			...
			"sAjaxSource": "/pazysalvo/retirar_c/consultarTodosusuarios/",
			"oLanguage": {"sUrl": "/recursos/js/datatables/media/language/espanol.txt"}
		});
	}	
$(document).ready(function(){
	dtl();
	$('#usuarios').on('click','.add',function(){
		var codigo = $(this).attr('data-cod');var nombre = $(this).attr('data-nom');
		window.parent.datoUsuario(codigo,nombre);
		});
...
<th width="70%">Nombres y Apellidoss</th>
<th width="10%"></th>
</tr>
</thead> 
<tbody>
