...
$(document).ready(function() {
	...
	oTable = $('#hojadevida').dataTable( {
			...
			"sAjaxSource": "/pazysalvo/retirar_c/contratados/",
	...
	<div id="tabla">
    	<table class="display" id="hojadevida" width="100%" cellpadding="0" cellspacing="0">
            ...
            <tr >
                ...
                <th width="10%"><input type="text" name="search_ID" value="ID" class="search_init" /></th>
										<th width="20%"><input type="text" name="search_Nombre" value="Nombres y Apellidos" class="search_init" /></th>
										<th width="26%"></th>
										<th width="22%"><input type="text" name="search_Cargos" value="Cargos" class="search_init" /></th>
										<th width="10%"></th>
										<th width="12%"></th>
									 </tr>
							</tfoot>
