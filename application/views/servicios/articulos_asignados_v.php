...
<link rel="stylesheet" href="<?php echo base_url();?>/recursos/jquery/css/blitzer/jquery-ui.custom.css"/>
<script type="text/javascript" src="<?php echo base_url();?>/recursos/js/jquery.js"></script>
<script type="text/javascript" src="<?php echo base_url();?>/recursos/jquery/js/jquery-ui.custom.min.js"></script>
<script type="text/javascript" src="<?php echo base_url();?>/recursos/js/datatables/media/js/jquery.dataTables.min.js"></script>
<script type="text/javascript">
function dtl(){
		iduser = '<?php echo $ideuser; ?>';
		oTable = $('#solicitar').dataTable( {
			...
			"sAjaxSource": "<?php echo base_url(); ?>servicios_c/articulos_por_usuario/"+iduser,
