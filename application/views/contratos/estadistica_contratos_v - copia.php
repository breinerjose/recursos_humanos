...
$(document).ready(function() {
	...
	$('#generar_reporte_excel').button().on('click',function(e){
		...
		var anio = $('#anio').val();
		var mes = $('#mes').val();
		if($('#empresa').is(':checked')){var f1=1; var f2=0; var f3=0;}
		else if($('#clientes').is(':checked')){var f1=0; var f2=1; var f3=0;}
		else if($('#consolidado').is(':checked')){var f1=0; var f2=0; var f3=1;}
		else{var f1=0; var f2=0; var f3=0;}
		if(anio != '' && (f1 != 0 || f2 != 0 || f3 != 0)){
		window.open("/contratos_c/generar_reporte_excel/"+anio+"/"+f1+"/"+f2+"/"+f3+"/"+mes);	
		}else{alert('Digite Año o Seleccione Tipo de Informe');}
		});
                    ...
                    <div class="form-group">
					  ...
					  <div class="clearfix"></div>
					   <div class="col-md-2">
                      <div class="form-group">
					  <label>Por Asap - Aseco: </label>
					  <input name="check" id="empresa" type="checkbox" value="1">
					  </div>
					  </div>
					   ...
					   <div class="col-md-2">
                      <div class="form-group">
					  <label>Por Clientes: </label>
					  <input name="check" id="clientes"  type="checkbox" value="1" checked="checked">
					  </div>
					  </div>
					  ...
					  <input name="check" id="consolidado" type="checkbox" value="1">
					  </div>
					  </div>
