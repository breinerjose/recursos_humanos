 ...
 <div class="x_title titulo" id="">
                    <h2 class="color-info">Agregar Colores</h2>
                    <div class="clearfix"></div>
                       ...
                       <div class="row">   
                            ...
                            <label>Codigo</label>
							<input class="form-control requerid" id="codlin" name="codlin" type="Text" disabled="disabled">
                          </div>
                            </div>
                            ...
                            <div class="form-group">
                            <label>Nombre</label>
							<input class="form-control requerid" id="nomcol" name="nomcol" type="Text">
                          </div>
                            </div>
...
<div class="row" id="tabla-listado">
	<div class="col-md-12">
	  <div class="form-group">
			<button class="btn btn-primary" id="add"><i class="fa fa-plus"></i> Agregar Colores</button>
		</div>
	</div>
