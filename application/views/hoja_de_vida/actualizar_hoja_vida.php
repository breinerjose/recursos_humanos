...
<html lang="es">
  ...
  <body >
    ...
    <!-- Flot -->
                    ...
                    <center>
                      <h4><strong>DATOS BASICOS DEL SOLICITANTE</strong>.</h4>
                    </center><br>
					...
					<div class="form-group">
                        ...
                        <div class="item col-md-3 col-sm-3 col-xs-12">
                          <input id="Cedula" class="form-control col-md-3 col-xs-12" name="Cedula" type="text" readonly 
						  value="<?php echo $this->session->userdata('user'); ?>" required="required" >
                        </div>
				   ...
				   <div class="form-group">
					...
					<div class="form-group">
					  ...
					  <center>
					  <button id="send" type="submit" class="btn btn-success"><i class="fa fa-pencil"></i> Actualizar Datos</button> 
					  </center>
                    </form>
					</div></div></div>
 ...
 <!-- validator -->
    <script>
      ...
      $.ajax({
      url:   '/hoja_de_vida_c/actualizarDatosHojaVida/',
      data: {PrimerNombre,  SegundoNombre, PrimerApellido, SegundoApellido, Cedula, DeCedula, FechaNacimiento, LugarNacimiento, Email, Direccion,
Ciudad, ValorArriendo, TiempoCasaAnio, TiempoCasaMes, TipoCasa, Telefono, Celular, NombreFamiliar, TelefonoFamiliar, NombreVecino, TelefonoVecino, EstadoCivil, NumeroHijos,  Bachillerato, InicioBachillerato, FinBachillerato, Grado, InstitucionEstudio, Estudios, InicioEstudios, FinEstudios, NombreTitulo, EstudiosActualmente, CiudadEmpresa1, UltimaEmpresa1, DireccionEmpresa1, TelefonoEmpresa1, CargoDesempenado1, UltimoSalario1, Supervisor1, InicioEmpleo1,  FinEmpleo1, UltimaEmpresa2, DireccionEmpresa2, TelefonoEmpresa2, CargoDesempenado2, UltimoSalario2, Supervisor2, InicioEmpleo2,  FinEmpleo2, Sexo, CiudadEmpresa1, CiudadEmpresa2,Estudios2,InstitucionEstudio2,InicioEstudios2,FinEstudios2,NombreTitulo2,laborppal},
	...
	// window.location="http://www.asapaseco.com";
	  ...
	  function cargarDatos(){
	  	$.ajax({
			url:'/hoja_de_vida_c/cargarDatos/',
			type:'POST',
			dataType:'JSON',
			data:{"nriper":"<?php echo $this->session->userdata('user'); ?>"},
			success(ans){
			if(ans.err=='1'){
				$('#PrimerNombre').val(ans.info.PrimerNombre);
				$('#SegundoNombre').val(ans.info.SegundoNombre);
				$('#PrimerApellido').val(ans.info.PrimerApellido);
				$('#SegundoApellido').val(ans.info.SegundoApellido);
				$('#DeCedula').val(ans.info.DeCedula);
				$('#FechaNacimiento').val(ans.info.FechaNacimiento);
				$('#LugarNacimiento').val(ans.info.LugarNacimiento);
				$('#Email').val(ans.info.Email);
				$('#Direccion').val(ans.info.Direccion);
				$('#Ciudad').val(ans.info.Ciudad);
				$('#ValorArriendo').val(ans.info.ValorArriendo);
				$('#TiempoCasaAnio').val(ans.info.TiempoCasaAnio);
				$('#TiempoCasaMes').val(ans.info.TiempoCasaMes);
				$('#TipoCasa').val(ans.info.TipoCasa);
				$('#Telefono').val(ans.info.Telefono);
				$('#Celular').val(ans.info.Celular);
				$('#NombreFamiliar').val(ans.info.NombreFamiliar);
				$('#TelefonoFamiliar').val(ans.info.TelefonoFamiliar);
				$('#NombreVecino').val(ans.info.NombreVecino);
				$('#TelefonoVecino').val(ans.info.TelefonoVecino);
				$('#EstadoCivil').val(ans.info.EstadoCivil);
				$('#NumeroHijos').val(ans.info.NumeroHijos);
				$('#DireccionEmpresa').val(ans.info.DireccionEmpresa);
				$('#TelefonoEmpresa').val(ans.info.TelefonoEmpresa);
				$('#CargoDesempenado').val(ans.info.CargoDesempenado);
				$('#UltimoSalario').val(ans.info.UltimoSalario);
				$('#Supervisor').val(ans.info.Supervisor);
				$('#InicioEmpleo').val(ans.info.InicioEmpleo);
				$('#FinEmpleo').val(ans.info.FinEmpleo);
				$('#Bachillerato').val(ans.info.Bachillerato);
				$('#InicioBachillerato').val(ans.info.InicioBachillerato);
				$('#FinBachillerato').val(ans.info.FinBachillerato);
				$('#Grado').val(ans.info.Grado);
				$('#Estudios').val(ans.info.Estudios);
				$('#InstitucionEstudio').val(ans.info.InstitucionEstudio);
				$('#InicioEstudios').val(ans.info.InicioEstudios);
				$('#FinEstudios').val(ans.info.FinEstudios);
				$('#NombreTitulo').val(ans.info.NombreTitulo);
				$('#EstudiosActualmente').val(ans.info.EstudiosActualmente);
				$('#CiudadEmpresa').val(ans.info.CiudadEmpresa);
				$('#UltimaEmpresa1').val(ans.info.UltimaEmpresa1);
				$('#DireccionEmpresa1').val(ans.info.DireccionEmpresa1);
				$('#TelefonoEmpresa1').val(ans.info.TelefonoEmpresa1);
				$('#CargoDesempenado1').val(ans.info.CargoDesempenado1);
				$('#UltimoSalario1').val(ans.info.UltimoSalario1);
				$('#Supervisor1').val(ans.info.Supervisor1);
				$('#InicioEmpleo1').val(ans.info.InicioEmpleo1);
				$('#FinEmpleo1').val(ans.info.FinEmpleo1);
				$('#UltimaEmpresa2').val(ans.info.UltimaEmpresa2);
				$('#DireccionEmpresa2').val(ans.info.DireccionEmpresa2);
				$('#TelefonoEmpresa2').val(ans.info.TelefonoEmpresa2);
				$('#CargoDesempenado2').val(ans.info.CargoDesempenado2);
				$('#UltimoSalario2').val(ans.info.UltimoSalario2);
				$('#Supervisor2').val(ans.info.Supervisor2);
				$('#InicioEmpleo2').val(ans.info.InicioEmpleo2);
				$('#FinEmpleo2').val(ans.info.FinEmpleo2);
				$('#Sexo').val(ans.info.Sexo);
				$('#CiudadEmpresa1').val(ans.info.CiudadEmpresa1);
				$('#CiudadEmpresa2').val(ans.info.CiudadEmpresa2);
				$('#Estudios2').val(ans.info.Estudios2);
				$('#InstitucionEstudio2').val(ans.info.InstitucionEstudio2);
				$('#InicioEstudios2').val(ans.info.InicioEstudios2);
				$('#FinEstudios2').val(ans.info.FinEstudios2);
				$('#NombreTitulo2').val(ans.info.NombreTitulo2);
				$('#laborppal').val(ans.info.laborppal);
				$('#FechaSolicitud').val(ans.info.FechaSolicitud);
